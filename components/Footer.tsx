      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Colorado Springs Hikes is your guide to exploring the beautiful
              trails and outdoor adventures in the Colorado Springs area.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="mailto:ojvwebdesign@gmail.com"
                  className="hover:text-white transition-colors"
                >
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/coloradospringshikes"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/coloradospringshikes"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors"
              >
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
          <p>
            © {new Date().getFullYear()} Colorado Springs Hikes. All rights
            reserved.
          </p>
        </div>
      </div>
